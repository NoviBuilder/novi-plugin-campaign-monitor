...
export default class CampaignMonitorSettings extends Component {
    constructor(props) {
        super();
        this.state = {
        ...
        this.messages = Language.getDataByKey("novi-plugin-campaign-monitor");
    }
    ...
    render() {
        return (
            <div>
                <span style={{letterSpacing: "0,0462em"}}>Campaign Monitor Plugin</span>
    ...
    saveSettings(){
        novi.plugins.settings.update("novi-plugin-campaign-monitor", this.state.settings);
    }
}